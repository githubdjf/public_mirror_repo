...
class MultiSelectionItemView: UIView {
    ...
    func initialize(withItemOption option: AssCaseOption, titleFont font: UIFont, titleColor textColor: UIColor, contentInset inset: UIEdgeInsets, fixedWidth: CGFloat, fixedHeight: CGFloat, compactable compact: Bool) -> CGSize {
        ...
        let selectImage = UIImage(named: "recruit_student_ass_selected_answer")!
        
        let titleRect = CGRect(x: 10, y: 0, width: itemSize.width - 10 - selectImage.size.width, height: itemSize.height)
        ...
        let imageRect = CGRect(x: itemSize.width - selectImage.size.width, y: 0, width: selectImage.size.width, height: selectImage.size.height)
...
class Ass_Patten_MultiSelectionView: Ass_Patten_View {
    ...
    override func initViews() {
        ...
        //option view
        caseOptionContainerView = MultiSelectionContainerView(frame: CGRect(x: 0, y: 0, width: self.frame.width, height: containerDefaultHeight))
...
class AssPattenMultiSelectionCell: AssPattenCell {
    ...
    override func initViews() {
        ...
        caseView = Ass_Patten_MultiSelectionView(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 0))
