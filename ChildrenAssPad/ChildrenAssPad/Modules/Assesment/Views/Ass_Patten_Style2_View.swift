...
class Ass_Patten_Style2_View: Ass_Patten_View {
    ...
    func reloadView(withData caseData: AssCase, columnCount: Int, containerInset: UIEdgeInsets, spaceX: CGFloat, spaceY: CGFloat) {
        ...
        for (idx, itemData) in optionsDataArray.enumerated() {
            ...
            let _ = itemView.initialize(withIndicatorTitle: "\(itemData.optionType). ", itemTitle: itemData.optionText, titleFont: itemFont, lineNumber: 1, breakMode: .byTruncatingTail, contentInset: itemInset, isFixWidth: true, fixedWidth: itemWidth, minWidth: 0, isFixHeight: true, fixedHeigth: defaultOptionHeight, minHeight: defaultOptionHeight)
...
class Ass_Patten_Style2_Cell: AssPatternStyleCell {
    
    var patternView: Ass_Patten_Style2_View!
    ...
    override func initViews() {
        ...
        patternView = Ass_Patten_Style2_View(frame: rect)
