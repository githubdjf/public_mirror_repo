...
class Ass_Patten_Style7_View: Ass_Patten_View {
    ...
    override init(frame: CGRect) {
        ...
        bgImageview = UIView()
        bgImageview.layer.shadowColor = UIColor.colorFromRGBA(0, 0, 0).cgColor
        bgImageview.layer.shadowRadius = 8
        ...
        imageView.snp.makeConstraints { (maker) in
           maker.edges.equalTo(bgImageview.snp.edges).inset(UIEdgeInsets.init(top: 2, left: 2, bottom: 2, right: 2))
        }
